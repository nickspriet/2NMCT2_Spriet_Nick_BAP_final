...
namespace nmct.ba.cashlessproject.helper
{
    ...
    {
        //zelf deze methode verplaatst
        public static ConnectionStringSettings CreateConnectionStringFromClaims(IEnumerable<Claim> claims)
        {
            string dblogin = claims.FirstOrDefault(c => c.Type == "dblogin").Value;
            string dbpass = claims.FirstOrDefault(c => c.Type == "dbpass").Value;
            string dbnaam = claims.FirstOrDefault(c => c.Type == "dbnaam").Value;
            
            return CreateConnectionString("System.Data.SqlClient", @"LAPTOP-NICK\DATAMANAGEMENT", Cryptography.Decrypt(dbnaam), Cryptography.Decrypt(dblogin), Cryptography.Decrypt(dbpass));
        }
        ...
        public static DbParameter AddParameter(string ConnectionString, string name, object value)
        {
            ...
            par.Value = value;
            if (par.Value is string && par.Value == null) par.Value = DBNull.Value;    //zelf toegevoegd
